...
============================
    rpm -ivh https://hpc.lenovo.com/yum/19a/el7/x86_64/lenovo-hpc-yum-1-1.x86_64.rpm
...
============================
    zypper install http://hpc.lenovo.com/yum/19a/suse15/x86_64/lenovo-hpc-zypper-1-1.x86_64.rpm
...
The files are located at [https://hpc.lenovo.com/downloads/19a]( https://hpc.lenovo.com/downloads/19a "https://hpc.lenovo.com/downloads/19a" ):
    ...
    wget https://hpc.lenovo.com/downloads/19a/xcat-<xcat version>.lenovo1_confluent-<confluent client/server version>-<osver>.tar.bz2
